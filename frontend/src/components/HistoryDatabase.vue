...
<div class="modal-playback-hint">
              <span class="hint-text">Step3Start simulation Step5Deep interaction</span>
            </div>
          </div>
        </div>
      </Transition>
...
.status-icon:nth-child(3).available { color: #10B981; } /* Analysis report -  */
...
/* progressstate */
.card-progress.completed { color: #10B981; }    /* Done -  */
.card-progress.in-progress { color: #F59E0B; }  /* In progress -  */
.card-progress.not-started { color: #9CA3AF; }  /* Not started -  */
