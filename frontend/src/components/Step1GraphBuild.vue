...
<div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            The LLM analyzes the documents and simulation requirements, extracts real-world seeds, and generates a suitable ontology.
          </p>
...
<div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">GraphRAGbuild</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Using the generated ontology, the documents are chunked automatically and sent to Zep to build the knowledge graph, extract entities and relations, and produce temporal memory and community summaries.
          </p>
<div class="stats-grid">
            ...
            <div class="stat-card">
              ...
              <span class="stat-label">SCHEMAtypes</span>
            </div>
          </div>
        </div>
      </div>
<div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        ...
        <div class="card-content">
          ...
          <p class="description">Graph build is complete. Continue to simulation environment setup.</p>
          <button 
            class="action-btn" 
