...
:
    ...
    python run_twitter_simulation.py --config /path/to/simulation_config.json --no-wait  # completeafter
"""
...
class TwitterSimulationRunner:
    ...
    def _get_profile_path(self) -> str:
        """GetProfilepathOASIS TwitterCSV"""
