...
Persists project state on the server to avoid passing large payloads between frontend calls
"""
...
class Project:
    ...
    # Ontology data (filled after API step 1)
    ontology: Optional[Dict[str, Any]] = None
    analysis_summary: Optional[str] = None
    
    # Graph data (filled after API step 2)
...
class ProjectManager:
    """Project manager for persistent storage and lookup."""
    ...
    def get_project(cls, project_id: str) -> Optional[Project]:
        ...
        Returns:
            Project object, or None if missing
        """
